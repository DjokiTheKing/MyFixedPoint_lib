...
#else
    value = int32_t(float(val) * float(1L<<FRAC_BITS)+(val>=0?0.5f:-0.5f));
#endif
}
...
#else
    value = int32_t(val * float(1L<<FRAC_BITS)+(val>=0?0.5f:-0.5f));
#endif
}
...
{
    fixed res;
    res.value = int32_t((int64_t(value)*int64_t(other.value)+(1LL << (FRAC_BITS - 1))) >> FRAC_BITS);
    return res;
}
...
inline fixed fixed::operator+(const double &other) const
{
#ifdef PICO_RP2040
    fixed res;
    res.value = value+float2fix(float(other), FRAC_BITS);
    return res;
#else
    fixed res;
    res.value = value+int32_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f));
    return res;
#endif
}
...
#ifdef PICO_RP2040
    fixed res;
    res.value = int32_t((int64_t(value)*int64_t(float2fix(float(other), FRAC_BITS))+(1LL << (FRAC_BITS - 1))) >> FRAC_BITS);
    return res;
#else
    fixed res;
    res.value = int32_t((int64_t(value)*int64_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f))+(1LL << (FRAC_BITS - 1))) >> FRAC_BITS);
    return res;
#endif
}
...
#ifdef PICO_RP2040
    fixed res;
    res.value = int32_t((int64_t(value)<<FRAC_BITS)/int64_t(float2fix(float(other), FRAC_BITS)));
    return res;
#else
    fixed res;
    res.value = int32_t((int64_t(value)<<FRAC_BITS)/int64_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f)));
    return res;
#endif
}
...
#else
    fixed res;
    res.value = value+int32_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f));
    return res;
#endif
}
...
#ifdef PICO_RP2040
    fixed res;
    res.value = int32_t((int64_t(value)*int64_t(float2fix(other, FRAC_BITS))+(1LL << (FRAC_BITS - 1))) >> FRAC_BITS);
    return res;
#else
    fixed res;
    res.value = int32_t((int64_t(value)*int64_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f))+(1LL << (FRAC_BITS - 1))) >> FRAC_BITS);
    return res;
#endif
}
...
#else
    fixed res;
    res.value = int32_t((int64_t(value)<<FRAC_BITS)/int64_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f)));
    return res;
#endif
}
...
inline fixed &fixed::operator*=(const fixed &other)
{
    value = int32_t((int64_t(value)*int64_t(other.value)+(1LL << (FRAC_BITS - 1))) >> FRAC_BITS);
    return *this;
}
...
inline fixed &fixed::operator+=(const double &other)
{
#ifdef PICO_RP2040
    value += float2fix(float(other), FRAC_BITS);
    return *this;
#else
    value += int32_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f));
    return *this;
#endif
}
...
{
#ifdef PICO_RP2040
    value = int32_t((int64_t(value)*float2fix64(float(other), FRAC_BITS)+(1LL << (FRAC_BITS - 1)))>>FRAC_BITS);
    return *this;
#else
    value = int32_t((int64_t(value)*int64_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f))+(1LL << (FRAC_BITS - 1)))>>FRAC_BITS);
    return *this;
#endif
}
...
{
#ifdef PICO_RP2040
    value = int32_t((int64_t(value)<<FRAC_BITS)/float2fix64(float(other), FRAC_BITS));
    return *this;
#else
    value = int32_t((int64_t(value)<<FRAC_BITS)/int64_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f)));
    return *this;
#endif
...
inline fixed &fixed::operator+=(const float &other)
{
    ...
    return *this;
#else
    value += int32_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f));
    return *this;
#endif
}
...
{
#ifdef PICO_RP2040
    value = int32_t((int64_t(value)*float2fix64(other, FRAC_BITS)+(1LL << (FRAC_BITS - 1)))>>FRAC_BITS);
    return *this;
#else
    value = int32_t((int64_t(value)*int64_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f))+(1LL << (FRAC_BITS - 1)))>>FRAC_BITS);
    return *this;
#endif
}
...
inline fixed &fixed::operator/=(const float &other)
{
    ...
    return *this;
#else
    value = int32_t((int64_t(value)<<FRAC_BITS)/int64_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f)));
    return *this;
#endif
...
inline fixed &fixed::operator=(const double &other)
{
    ...
    return *this;
#else
    value = int32_t(float(other) * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f));
    return *this;
#endif
}
...
inline bool fixed::operator> (const double &other) const
{
#ifdef PICO_RP2040
    return value > float2fix(float(other), FRAC_BITS);
#else
    return value > int32_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f));
#endif
}
...
#else
    return value > int32_t(other * float(1L<<FRAC_BITS)+(other>=0?0.5f:-0.5f));
#endif
}
...
{
#ifdef PICO_RP2040
    fixed res; res.value = value%float2fix(float(other), FRAC_BITS);
    return res;
#else
    fixed res; res.value = value%int32_t(float(other) * float(1L<<FRAC_BITS)+(float(other)>=0?0.5f:-0.5f));
    return res;
#endif
}
